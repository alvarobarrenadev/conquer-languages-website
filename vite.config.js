  ...
  build: {
    rollupOptions: {
      input: {
        ...
        article2: resolve(__dirname, "cinco-consejos-ingles.html"),
        article3: resolve(__dirname, "diez-palabras-ingles.html"),
        article4: resolve(__dirname, "idiomas-extranjero.html"),
      },
    },
  },
  resolve: {
